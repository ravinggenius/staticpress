...
class RouteTest < TestHelper
  def setup
    ...
    @route_fake = Staticpress::Route.new
  ...
  def test_inspect
    ...
    assert_equal '#<Staticpress::Route params={}>', @route_fake.inspect
  end
  ...
  def test_params
    ...
    assert_equal({ }, @route_fake.params)
  end
